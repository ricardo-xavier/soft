...
namespace acao
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.dgvAcoes.DefaultCellStyle = dataGridViewCellStyle4;
			...
			this.dgvContatos.DefaultCellStyle = dataGridViewCellStyle5;
			...
			this.Text = "Sistema SOFT - Ação Comercial - v2.9.0 (15/05/21)";
